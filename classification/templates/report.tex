...
\begin{figure}
   ...
   \begin{subfigure}{\textwidth}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_initial_comp_normal_dedup_Random_stats}
      \end{subfigure}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_initial_comp_normal_dedup_Selected_stats}
      \end{subfigure}
   ...
   \begin{subfigure}{\textwidth}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_initial_comp_indiv_pregating_dedup_Random_stats}
      \end{subfigure}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_initial_comp_indiv_pregating_dedup_Selected_stats}
      \end{subfigure}
...
\begin{figure}
   ...
   \begin{subfigure}{\textwidth}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_initial_comp_normal_dedup_Random_auc}
      \end{subfigure}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_initial_comp_normal_dedup_Selected_auc}
      \end{subfigure}
      \caption{Normal gating - Random v Selected}
   \end{subfigure}
   ...
   \begin{subfigure}{\textwidth}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_initial_comp_indiv_pregating_dedup_Random_auc}
      \end{subfigure}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_initial_comp_indiv_pregating_dedup_Selected_auc}
      \end{subfigure}
      \caption{Individual pregating - Random v Selected}
   \end{subfigure}
...
\begin{figure}
   ...
   \begin{subfigure}{\textwidth}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_comp_pregating_pregated_combined_dedup_Random_auc}
      \end{subfigure}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_comp_pregating_somgated_dedup_Random_auc}
      \end{subfigure}
   ...
   \begin{subfigure}{\textwidth}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_comp_pregating_som_combined_dedup_Random_auc}
      \end{subfigure}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_comp_pregating_always_som_dedup_Random_auc}
      \end{subfigure}
   ...
   \begin{subfigure}{\textwidth}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_comp_pregating_som_dedup_Random_auc}
      \end{subfigure}
...
\begin{figure}
   ...
   \begin{subfigure}{\textwidth}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_comp_pregating_som_combined_dedup_Random_stats}
      \end{subfigure}
      \begin{subfigure}{0.5\columnwidth}
         \includegraphics[width=\columnwidth]{predictions_comp_pregating_somgated_dedup_Random_stats}
      \end{subfigure}
...
\begin{figure}
   \centering
   \includegraphics[width=\textwidth]{missed_frequency}
